-- CreateEnum
CREATE TYPE "EstadoReserva" AS ENUM ('reservado', 'checkin', 'checkout');
...
CREATE TABLE "Habitacion" (
    ...
    CONSTRAINT "Habitacion_pkey" PRIMARY KEY ("numero_habitacion")
);
...
-- AddForeignKey
ALTER TABLE "Reserva" ADD CONSTRAINT "Reserva_numero_habitacion_fkey" FOREIGN KEY ("numero_habitacion") REFERENCES "Habitacion"("numero_habitacion") ON DELETE RESTRICT ON UPDATE CASCADE;
